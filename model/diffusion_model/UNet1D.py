...
class WeightNormParam(nn.Module):
    def forward(self, w):
...
class Conv1d(Module):
    def __init__(
        ...
        parametrize.register_parametrization(self, "weight", WeightNormParam())
    ...
    def forward(self, x):
        weight = self.weight / sqrt(self.fan_in)
    ...
    def __init__(
        ...
        *,
        ...
        if self.needs_class_labels:
            self.to_class_emb = nn.Embedding(num_classes, emb_dim)
