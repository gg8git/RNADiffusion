...
from datamodules.selfies_datamodule import SELFIESDataset, collate_fn
from model.mol_vae_lolbo.mol_vae import MoleculeInfoTransformerVAE
...
class MoleculeObjective:
    ...
    def initialize_vae(self):
        ...
        self.vae = MoleculeInfoTransformerVAE(dataset=self.dataobj)
